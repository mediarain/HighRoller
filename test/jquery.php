 ...
 * Date: 9/21/11
 * Time: 8:02 PM
 * Desc: HighRoller jQuery Test Suite
 *
...
<html>
<head>
  <title>HighRoller | jQuery Test Suite</title>
...
<div class="main">
  ...
  <img class="logo" src="_assets/red_dice.png"><h1>HighRoller: jQuery Test Suite</h1>
  ...
  <div class="page">
    ...
    <h5>jQuery Test Suite</h5>
    <p>
      <ul>
        <li>This page renders the 8 default chart types provided by Highcharts using HighRoller and <strong>jQuery.</strong></li>
    ...
    <p>
      ...
      <p>Once all jQuery test cases pass, move onto the <a href="/mootools.php">MooTools</a> test suite...</p>
    ...
    <script type="text/javascript">
      ...
      <?php echo $piechart->renderChart();?>

      <?php echo $barchart->renderChart();?>
      <?php echo $columnchart->renderChart();?>
      <?php echo $linechart->renderChart();?>
      <?php echo $splinechart->renderChart();?>
      <?php echo $areachart->renderChart();?>
      <?php echo $areasplinechart->renderChart();?>
      <?php echo $scatterchart->renderChart();?>
